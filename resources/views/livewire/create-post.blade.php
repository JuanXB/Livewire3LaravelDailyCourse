<div>
    ...
    <form method="POST" wire:submit='save'>
        <div>
            ...
            <input id="title" wire:model="postForm.title" wire:keydown="validateTitle" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" />
        ...
        <div class="mt-4">
            ...
            <textarea id="body" wire:model.blur="postForm.body"
